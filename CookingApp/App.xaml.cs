        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (e.PrelaunchActivated == false)
            {
                if (rootFrame.Content == null)
                {
                    ...
                    // check here to see if user is registered, if so go main page, otherwise go to registeruser info page

                    rootFrame.Navigate(typeof(RegisterUserInfo), e.Arguments);
                }
